      ...
      <div class="lock__top-content">
        ...
        <div class="lock__screen-info">
          <p class="lock__info-text">
            {{ currentTimeData.dayName }}, {{ currentTimeData.dayNumber }} {{ currentTimeData.monthName }}
          </p>
        ...
        >
          <g>
            <g>
              ...
              <path
                style="fill: #fff"
                d="M100.691,0v49.644l59.669,83.536v283.009h89.503V133.336l65.636-83.536V0
