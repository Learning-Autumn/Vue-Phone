<template>
  <div class="calculator__program">
    <svg class="calculator__program-menu" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    <div class="calculator__program-inner">
      <div class="calculator__program-display">
        <input v-if="!isOperation" class="calculator__program-display--input" v-model="resultNumber"
          :placeholder="resultNumber === '' ? '0' : ''" type="" name="" value="" />
        <input v-else class="calculator__program-display--input" v-model="nextNumber"
          :placeholder="nextNumber === '' ? '0' : ''" type="" name="" value="" />
        <!-- <label class="calculator__program-display--label" for="">0.77734</label> -->
      </div>
      <div class="calculator__program-controls">
        <button @click="clearNumber" class="calculator__program-control-btn calculator__program-control-btn--gray"
          type="">
          AC
        </button>
        <button @click="signNumber" data-type="+/-"
          class="calculator__program-control-btn calculator__program-control-btn--gray" type="">
          +/-
        </button>
        <button @click="procOperation($event)" data-type="%" class="calculator__program-control-btn calculator__program-control-btn--gray" type="">
          %
        </button>
        <button @click="procOperation($event)" data-type="/"
          class="calculator__program-control-btn calculator__program-control-btn--orange" type="">
          <svg fill="#fff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 472.615 472.615" xml:space="preserve" width="32px"
            height="32px" stroke="#fff" stroke-width="0.00472615">
        ...
        <button @click="enteringNumbers($event)"
          class="calculator__program-control-btn calculator__program-control-btn--black" type="">
          7
        </button>
        <button @click="enteringNumbers($event)"
          class="calculator__program-control-btn calculator__program-control-btn--black" type="">
        ...
        <button class="calculator__program-control-btn calculator__program-control-btn--black" type="">
          <svg width="40px" height="40px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#2a2a2c"
            stroke="#2a2a2c">
            <g id="SVGRepo_bgCarrier" stroke-width="0" />
            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
            <g id="SVGRepo_iconCarrier">
        ...
        <button data-type="." class="calculator__program-control-btn calculator__program-control-btn--black" type="">
          .
        </button>
        <button @click="procOperation($event)" data-type="="
          class="calculator__program-control-btn calculator__program-control-btn--orange" type="">
    ...
    procOperation(event) {
      ...
      if (operPressed === "=") {
        ...
        if (operations[this.isOperation]) {
          this.resultNumber = operations[this.isOperation](Number(this.resultNumber), Number(this.nextNumber));
        }
        this.isOperation = "";
        this.nextNumber = "";
      }
